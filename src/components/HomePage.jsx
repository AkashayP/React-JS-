  ...
  return (
    <div className="home-container">
      ...
      <div className="button-group">
        <button className="shrink-button"><Link className="link" to="/signup">Learn More</Link></button>
        <button className="shrink-button2"><Link className="link" to="/">Book a Demo</Link></button>
      </div>
